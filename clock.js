...
var setAlarm = $("#submit"), alarmHour, alarmMinutes, alarmMeridian, checkCompare;
...
setAlarm.click(function() {
  ...
  checkCompare = setInterval(function() {
    ...
    var currentTime = hoursCompare + ":" + minutesCompare + " " + meridianCompare;

    var myAlarm = alarmHour + ":" + alarmMinutes + " " + alarmMeridian;

    if (myAlarm == currentTime) {
      beepBeep.play();
    }
  }, 1000);
});
